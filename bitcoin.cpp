...
#define BITCOIN_SEED_NONCE 0x0539a019ca550826
...
class CNode {
  ...
  void PushVersion() {
    ...
    CAddress me(CService("0.0.0.0",0));
    BeginMessage("version");
    int nBestHeight = GetRequireHeight();
    string ver = "/SPACEBUX-SEEDER:0.1.1/";
    bool fRelayTx=false;
    vSend <<PROTOCOL_VERSION << nLocalServices << nTime << you << me << nLocalNonce << ver << nBestHeight << fRelayTx;
    EndMessage();
  }
